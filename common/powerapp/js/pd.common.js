...
export const pdHtml = {
	...
	*/
	...
	// 通过webview的id来获取webview【父webview让子webview执行某个方法】
	fireMsg(js,key){
		key = key || 'subid'
...
// 		scriptNew.charset = 'UTF-8';
// 		scriptNew.src = src;
// 	  if (scriptNew.addEventListener) {
// 		scriptNew.addEventListener('load', function () {
// 		  callback();
// 		}, false);
// 	  } else if (scriptNew.attachEvent) {
// 		scriptNew.attachEvent('onreadystatechange', function () {
